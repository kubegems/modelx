...
require (
	...
	src.cloudminds.com/blockchain/vault/vault-sdk-go v1.1.15
)
...
require (
	...
	src.cloudminds.com/blockchain/vault/contracts-lib-go v1.1.0 // indirect
)
...
replace (
	github.com/ethereum/go-ethereum => src.cloudminds.com/blockchain/lpc/go-lpc v0.2.8
