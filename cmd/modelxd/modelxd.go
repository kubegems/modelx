...
func NewRegistryCmd() *cobra.Command {
	...
	flags.StringVar(&options.Oauth.Server, "oauth-server", options.Oauth.Server, "oauth server addr")
	flags.StringVar(&options.Oauth.ValidatePath, "oauth-validate-path", options.Oauth.ValidatePath, "oauth validate path")
