...
require (
	...
	src.cloudminds.com/blockchain/vault/vault-sdk-go v1.1.17
)
...
require (
	...
	src.cloudminds.com/blockchain/vault/contracts-lib-go v1.1.4 // indirect
)

replace (
	github.com/ethereum/go-ethereum => src.cloudminds.com/blockchain/lpc/go-lpc v0.2.8-nocgo-r1
	github.com/tjfoc/gmsm => src.cloudminds.com/blockchain/lpc/gmsm v1.3.8
)
